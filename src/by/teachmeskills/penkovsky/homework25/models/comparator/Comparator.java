package by.teachmeskills.penkovsky.homework25.models.comparator;

import by.teachmeskills.penkovsky.homework25.models.Show;

import java.util.Map;

public class Comparator implements java.util.Comparator<Show> {
    private final Map<String, String> conditions;

    public Comparator(Map<String, String> conditions) {
