package by.teachmeskills.penkovsky.homework25.models.predicate;

import by.teachmeskills.penkovsky.homework25.models.comparator.Comparator;
import by.teachmeskills.penkovsky.homework25.repository.ShowRepository;
...
public class Application {
    ...
    private void customComparing(List<Show> shows) {
        ...
        Comparator myComparator=new Comparator(keyOfConditional);
